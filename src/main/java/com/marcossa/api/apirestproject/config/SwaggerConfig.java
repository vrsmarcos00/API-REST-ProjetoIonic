...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket (DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.marcossa.api.apirestproject.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo (
			...
			"Versão 1.0",
			"github.com/vrsmarcos00",
			new Contact ("Marcos de Sá", "github.com/vrsmarcos00", "vrr.marcos@gmail.com"),
