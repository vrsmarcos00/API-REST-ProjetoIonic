package com.marcossa.api.apirestproject.domain;
...
public class Cliente implements Serializable {
	...
	public Set<PerfilCliente> getPerfil(){
		return perfil.stream().map(x -> PerfilCliente.toEnum(x)).collect(Collectors.toSet());
	}
	
	public void addPerfil (PerfilCliente perfis) {
